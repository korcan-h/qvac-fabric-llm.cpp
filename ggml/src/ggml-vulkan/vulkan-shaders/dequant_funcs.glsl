...
vec4 dequantize4(uint ib, uint iqs, uint a_offset) {
    ...
    defined(DATA_A_PQ3_0) || defined(DATA_A_PQ3_0_64)
#include "tq_utils.glsl"
...
vec4 dequantize4(uint ib, uint iqs, uint a_offset) {
    ...
    defined(DATA_A_PQ4_0) || defined(DATA_A_PQ4_0_64)
#include "tq_utils.glsl"
...
vec2 get_dm(uint ib, uint a_offset) {
    ...
    defined(DATA_A_TBQ3_0) || defined(DATA_A_TBQ4_0) || defined(DATA_A_PQ3_0) || defined(DATA_A_PQ4_0) || defined(DATA_A_TBQ3_0_64) || defined(DATA_A_TBQ4_0_64) || defined(DATA_A_PQ3_0_64) || defined(DATA_A_PQ4_0_64) 
vec2 get_dm(uint ib, uint a_offset) {
